(function () {
  ...
  /** @ngInject */
  function roomsController(roomsFactory, $uibModal, $rootScope, $scope, authService) {
...
vm.onChangeRoom = function(){
  ...
  function deleteRoom(id) {
    ...
    function openAddReservationModal(){
      var modalInstance = $uibModal.open({
        animation: true,
        templateUrl: 'app/pages/rooms/addReservation/addReservations.html',
        controller: 'addReservationsController',
        controllerAs: 'add',
        size: 'md',
        resolve: {
